...
macro (configure_file_translation SOURCE RESULT PO_DIR)
    cmake_parse_arguments (ARGS "IS_DESKTOP;IS_GSCHEMA;IS_XML;IS_KEY" "" "" ${ARGN})
    ...
    set (INTLTOOL_FLAG "")
    if (${SOURCE} MATCHES ".desktop" OR ${ARGS_IS_DESKTOP})
        set (INTLTOOL_FLAG "--desktop-style")
    elseif (${SOURCE} MATCHES ".gschema" OR ${ARGS_IS_GSCHEMA})
        set (INTLTOOL_FLAG "--schemas-style")
    elseif (${ARGS_IS_KEY})
        set (INTLTOOL_FLAG "--keys-style")
    else ()
...
macro (add_translations_catalog NLS_PACKAGE)
    cmake_parse_arguments (ARGS "" "" "DESKTOP_FILES;APPDATA_FILES;SCHEMA_FILES;KEY_FILES" ${ARGN})
    ...
    IF((NOT "${ARGS_DESKTOP_FILES}" STREQUAL "") OR (NOT "${ARGS_KEY_FILES}" STREQUAL "") OR (NOT "${ARGS_APPDATA_SOURCE}" STREQUAL "") OR (NOT "${ARGS_SCHEMA_SOURCE}" STREQUAL ""))
        file(MAKE_DIRECTORY ${EXTRA_PO_DIR})
    ENDIF()

    set(CONTINUE_FLAG "")

    foreach(DESKTOP_SOURCE ${ARGS_DESKTOP_FILES} ${ARGS_KEY_FILES})
