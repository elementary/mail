...
public class PasswordDialog {
    ...
    private const string PRIMARY_TEXT_FIRST_TRY = _("Mail requires your email password to continue");
    ...
    public PasswordDialog(Gtk.Window? parent, bool smtp, Geary.AccountInformation account_information,
        ...
        Gtk.Builder builder = GearyApplication.instance.create_builder("password-dialog.ui");
