...
public class Mail.ComposerWidget : Gtk.Grid {
    ...
    construct {
        ...
        bold.tooltip_markup = Granite.Utils.markup_accel_tooltip ({"<Ctrl>B"}, _("Bold"));
        ...
        italic.tooltip_markup = Granite.Utils.markup_accel_tooltip ({"<Ctrl>I"}, _("Italic"));
        ...
        underline.tooltip_markup = Granite.Utils.markup_accel_tooltip ({"<Ctrl>U"}, _("Underline"));
        ...
        strikethrough.tooltip_markup = Granite.Utils.markup_accel_tooltip ({"<Ctrl>percent"}, _("Strikethrough"));
        ...
        indent_more.tooltip_markup = Granite.Utils.markup_accel_tooltip ({"<Ctrl>bracketright"}, _("Quote text"));

        var indent_less = new Gtk.Button.from_icon_name ("format-indent-less-symbolic", Gtk.IconSize.MENU);
        indent_less.tooltip_markup = Granite.Utils.markup_accel_tooltip ({"<Ctrl>bracketleft"}, _("Unquote text"));
        ...
        link.tooltip_markup = Granite.Utils.markup_accel_tooltip ({"<Ctrl>K"}, _("Insert Link"));

        var image = new Gtk.Button.from_icon_name ("insert-image-symbolic", Gtk.IconSize.MENU);
        image.tooltip_markup = Granite.Utils.markup_accel_tooltip ({"<Ctrl>G"}, _("Insert Image"));

        var clear_format = new Gtk.Button.from_icon_name ("format-text-clear-formatting-symbolic", Gtk.IconSize.MENU);
        clear_format.tooltip_markup = Granite.Utils.markup_accel_tooltip ({"<Ctrl>space"}, _("Remove formatting"));
        ...
        send.label = _("Send");
        send.tooltip_markup = Granite.Utils.markup_accel_tooltip ({"<Ctrl>ISO_Enter"});
