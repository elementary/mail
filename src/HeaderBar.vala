...
public class Mail.HeaderBar : Gtk.HeaderBar {
    ...
    construct {
        ...
        compose_button.tooltip_markup = Granite.Utils.markup_accel_tooltip ({"<Ctrl>N"}, _("Compose new message"));
        ...
        reply_button.tooltip_markup = Granite.Utils.markup_accel_tooltip ({"<Ctrl>R"}, _("Reply"));
        ...
        reply_all_button.tooltip_markup = Granite.Utils.markup_accel_tooltip ({"<Ctrl><Shift>R"}, _("Reply All"));
        ...
        forward_button.tooltip_markup = Granite.Utils.markup_accel_tooltip ({"<Ctrl><Shift>F"}, _("Forward"));
        ...
        trash_button.tooltip_markup = Granite.Utils.markup_accel_tooltip ({"Delete", "BackSpace"}, _("Move conversations to Trash"));
